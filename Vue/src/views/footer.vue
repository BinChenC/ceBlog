<template>
    ...
    <footer class="ui inverted vertical segment">
        ...
        <div class="ui center aligned container" style="padding-top: 2em">
            ...
            <div>
                <p class="m-text-thin m-text-spaced m-opacity-tiny" style="line-height: 0.1em !important;">
                    Copyright © 2020-2020 Cebb Designed by CB
                </p>
                <div class="ui inverted link list">
                    <a href="http://www.beian.miit.gov.cn/" target="view_window" class="item">闽ICP备20006817号</a>
                </div>
            </div>
