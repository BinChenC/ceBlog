                    ...
                    <div class="ui container">
                        <div style="padding: 0% 10% 0% 10%">
                            ...
                            <div class="field m-mobile-wide m-margin-top">
                                <button @click="handleAdd" class="ui teal button m-mobile-wide"><i class="edit icon"></i>新增</button>
                            </div>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            handleDelete(index, row) {
                this.$confirm('是否删除当前标签呢？', '提示', {
                    confirmButtonText: '删除',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    axios.delete('/blog/admin/tags/' + row.id).then(resp => {
            ...
            // 分页
            page(currentPage) {
                axios.get('/blog/admin/tags/' + (currentPage - 1) + '/5').then(resp => {
        ...
        created() {
            axios.get('/blog/admin/tags/0/5').then(resp => {
                this.tableData = resp.data.content
                this.pageSize = resp.data.size
                this.total = resp.data.totalElements
            })
