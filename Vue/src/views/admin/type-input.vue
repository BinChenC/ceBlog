                    ...
                    <div class="ui segment">
                        <div class="field">
                            <el-form-item prop="name" class="ui left icon input">
                                <el-input suffix-icon="el-icon-place" placeholder="类别名"
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        if ((this.$route.params.key == 'add')) {
                            axios.post('/blog/admin/types', this.ruleForm).then(resp => {
                            ...
                            axios.post('/blog/admin/types/' + this.$route.params.id + '/' + this.$route.params.name, this.ruleForm).then(resp => {
                                if (resp.data == 'success') {
                                    this.$message({
                                        offset: 140,
                                        message: '修改成功~',
